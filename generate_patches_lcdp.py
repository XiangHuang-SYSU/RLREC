...
src = 'your-path/LCDP/lcdp_dataset'
tar = 'your-path/LCDP/lcdp_dataset_crop/train_crops_640'
...
hr_files = natsorted(glob(os.path.join(src, 'gt', '*.png')) + glob(os.path.join(src, 'gt', '*.jpg')))
...
val_patch_size = 512
src = 'your-path/LCDP/lcdp_dataset'
tar = 'your-path/LCDP/lcdp_dataset_crop/val_crops'
...
lr_files = natsorted(glob(os.path.join(src, 'test-input', '*.png')) + glob(os.path.join(src, 'test-input', '*.jpg')))
hr_files = natsorted(glob(os.path.join(src, 'test-gt', '*.png')) + glob(os.path.join(src, 'test-gt', '*.jpg')))
